...
setup(
    ...
    packages=['mosaictools'] + ['mosaictools.' + p for p in find_packages(where='src', exclude=["mosaic_example_data", "mosaic_example_data.*", "notebooks", "notebooks.*"])],
    package_dir={'mosaictools': 'src'},
    install_requires=[
        'numpy<2.0',
        'scikit-learn',
        'scipy',
